...
export const products: Product[] = [
  ...
  },
  {
    ...
    category_id: 'b2c3d4e5-f6a7-4f8a-9b0c-1d2e3f4a5b6c',
    name: 'Mutton Salthilu',
    slug: 'mutton-salthilu',
    ...
    image_urls: ['/images/products/mutton-salthilu.webp'],
    is_active: true,
    is_featured: false,
    low_stock_threshold: 3,
    variants: [
      { id: 'p5-v1', product_id: '5a5a5a5a-5555-6666-7777-888888888888', weight_label: '1 Set', price: 1000, stock_qty: 6, is_active: true },
    ],
  },
  {
    ...
    image_urls: ['/images/products/killi.webp'],
    is_active: true,
    is_featured: false,
    low_stock_threshold: 5,
    variants: [
      { id: 'p6-v1', product_id: '6a6a6a6a-6666-7777-8888-999999999999', weight_label: '1 Set', price: 100, stock_qty: 15, is_active: true },
    ],
  },
  {
    id: '7a7a7a7a-7777-8888-9999-000000000000',
    category_id: 'c1a2b3c4-d5e6-4f7a-8b9c-0d1e2f3a4b5c',
    name: 'Mutton Keema',
    slug: 'mutton-keema',
    description: 'Premium minced mutton (goat meat), finely ground for perfect texture. Ideal for making keema curry, meatballs, and kebabs.',
    cooking_tips: 'Cook with spices and peas for a classic Keema Matar. Cook on medium heat for 15-20 minutes.',
    image_urls: ['/images/products/mutton-keema.webp'],
    is_active: true,
    is_featured: false,
    low_stock_threshold: 5,
    variants: [
      { id: 'p7-v1', product_id: '7a7a7a7a-7777-8888-9999-000000000000', weight_label: '500g', price: 600, stock_qty: 20, is_active: true },
      { id: 'p7-v2', product_id: '7a7a7a7a-7777-8888-9999-000000000000', weight_label: '1kg', price: 1200, stock_qty: 10, is_active: true },
    ],
  },
];
